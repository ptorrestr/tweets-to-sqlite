...
class Request(dict):
    ...
    def sign_request(self, signature_method, consumer, token):
        ...
        if not self.is_form_encoded:
            ...
            # request bodies."
            self['oauth_body_hash'] = base64.b64encode(sha(self.body.encode('ascii')).digest()).decode('ascii')
...
class SignatureMethod_HMAC_SHA1(SignatureMethod):
    ...
    def signing_base(self, request, consumer, token):
        ...
        #print(request.method+ request.normalized_url+request.get_normalized_parameters())
    ...
    def sign(self, request, consumer, token):
        ...
        #print(raw)        
        bytes_raw = raw.encode('utf-8')
        hashed = hmac.new(bytes_key, bytes_raw, sha)
